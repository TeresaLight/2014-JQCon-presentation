jQuery(document).ready(function(){
	...
	[	
		...
		{	id: "florida-shape", 			src: path + "assets/shapes/florida-s.png", 			data: "595,329" },																			
		...
		{	id: "montana-shape", 			src: path + "assets/shapes/montana-s.png", 			data: "284,43"  },																				
		...
		{	id: "newyork-shape", 			src: path + "assets/shapes/newyork-s.png", 			data: "688,100" },																				
	...
	[	
		...
		{	id: "florida-overlay", 			src: path + "assets/overlays/florida-o.png", 		data: "595,329" },																			
